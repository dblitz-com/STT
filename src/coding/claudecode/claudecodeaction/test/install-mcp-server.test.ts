...
// Mock core methods for testing (since we replaced @actions/core with kubernetes-core)
describe("prepareMcpConfig", () => {
  let coreInfoSpy: any;
  let coreWarningSpy: any;
  let coreSetFailedSpy: any;
  ...
  beforeEach(() => {
    ...
    coreSetFailedSpy = spyOn(core, "setFailed").mockImplementation(() => {});
