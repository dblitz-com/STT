...
export async function createInitialComment(
  ...
  const triggeredBy = context.payload.comment?.user?.login || context.payload.sender?.login;
  const initialBody = createCommentBody(jobRunLink, "", undefined, triggeredBy, 'started');
